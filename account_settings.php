    ...
    <?php
            ...
            <div class= "col-sm-8">
                ...
                <table class ="table table-bordered table-hover">
                    <tr align="center">
                        <td colspan="6" class="active"><h2>Change Your Settings</h2></td>
                    </tr>
                    <tr>
                ...
                font-size:15px;" href="upload.php"><i class="fa fa-user" aria-hidden="true"></i>Change Profile</a></td></tr>
                <tr>
                ...
                <td>
                    ...
                    <div id="myModal"class="modal fade" role="dialog" >
                        ...
                        <div class="modal-body">
                            ...
                            method="post" id="f">
                                <strong> What is Your Best Frineds Name?</strong>
                                ...
                                <pre> Above question is asked if you forget your <br>Password.</pre>
                                <br><br>
                            </form>
